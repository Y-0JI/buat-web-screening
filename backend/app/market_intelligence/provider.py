...
Mengikuti pola `IdxProvider`: reuse helper jaringan `_fetch_json` sehingga
rate-limit dan retry konsisten dengan Data Layer (16.4). Semua kegagalan aman —
return dict ber-key `error`,
